              ...
              <tbody className="divide-y divide-border">
                {orders.map((order) => {
                  ...
                  const deliveryStatus = order.deliveryStatus
                    ...
                    : null;
                  const canDeliver = canDeliverProductOrder(order);
                  const canCancel = canCancelProductOrder(order);
                  const canRefund = canRefundProductOrder(order);
